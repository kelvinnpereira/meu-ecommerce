...
class CartService:
    ...
    def get_cart_view(self, user_id: str) -> dict:
        """T-005: Generates a detailed view of the cart with calculated totals."""
        cart = self.get_or_create_cart(user_id)
        return self._calculate_totals(cart)
    ...
    def _calculate_totals(self, cart: Cart) -> dict:
        """
        Helper to calculate totals for the cart view.
        Returns a dictionary matching the structure for the view.
        """
